...
- Processing modes
  - `fast_trend`
  - `quality` (`Research Review` in the UI)
...
- `fast_trend` as the default operational mode for quick triage and practical review runs
- `quality` (`Research Review`) for slower analyst-led inspection and denser saved evidence
